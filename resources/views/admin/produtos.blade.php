            ...
            <li class="flex justify-between ">
                <div class="flex min-w-0 gap-x-4">
                    ...
                    <div class="min-w-0 flex-auto">
                        ...
                        <p class="mt-1 truncate text-xs/5 text-gray-500">Descrição do produto</p>
                    </div>
                </div>


                <div class="flex items-stretch gap-x-4">
                    <div class="pb-8 flex items-center gap-x-4">
                        <span
                            class="m-8 inline-flex items-center rounded-md bg-indigo-50 px-2 py-1 text-xs font-medium text-indigo-700 inset-ring inset-ring-indigo-700/10">Badge</span>


                        <div class="hidden shrink-0 sm:flex sm:flex-col sm:items-end">
                            <p class="text-sm/6 text-gray-900">Price</p>
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="hidden shrink-0 sm:flex sm:flex-col sm:items-end">
                        ...
                        <p class="text-sm/6 text-gray-900"><svg xmlns="http://www.w3.org/2000/svg" fill="none"
                        ...
                        <p class="mt-1 text-xs/5 text-red-500"><svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                                <path stroke-linecap="round" stroke-linejoin="round"
