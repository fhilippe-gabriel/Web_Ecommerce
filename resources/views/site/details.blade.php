        ...
        <div class="bg-white">
            <div class="pt-6">
                    ...
                    <ol role="list"
                        ...
                        <li>
                            <div class="flex items-center">
                                <a href="{{ route('site.index') }}" class="mr-2 text-sm font-medium text-gray-900">Home</a>
                        ...
                        <li>
                            <div class="flex items-center">
                                <a href="{{ route('site.categoria', $produto->categoria->id) }}"
                                    class="mr-2 text-sm font-medium text-gray-900">{{ $produto->categoria->nome }}</a>
                        ...
                        <li class="text-sm">
                            <a href="#" aria-current="page"
                                class="font-medium text-gray-500 hover:text-gray-600">{{ $produto->nome }}</a>
                        </li>
                    </ol>
                </nav>
                ...
                <div class="mx-auto mt-6 max-w-2xl sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:gap-8 lg:px-8">
                    {{-- <img src="{{ $produto->imagem }}" alt="Two each of gray, white, and black shirts laying flat." class="row-span-2 aspect-3/4 size-full rounded-lg object-cover max-lg:hidden" /> --}}
                    ...
                    <img src="{{ $produto->imagem }}" alt="Model wearing plain white basic tee."
                ...
                <div
                    ...
                    <div class="lg:col-span-2 lg:border-r lg:border-gray-200 lg:pr-8">
                        <h1 class="text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">{{ $produto->nome }}</h1>
                    </div>
                    ...
                    <div class="py-10 lg:col-span-2 lg:col-start-1 lg:border-r lg:border-gray-200 lg:pt-6 lg:pr-8 lg:pb-16">
                        ...
                        <div>
                            ...
                            <div class="space-y-6">
                                <p class="text-base text-gray-900">{{ $produto->descricao }}</p>
                            </div>
                        </div>
                            ...
                            <div class="mt-4">
                                <ul role="list" class="list-disc space-y-2 pl-4 text-sm">
                                    <li class="text-gray-400"><span
                                            class="text-gray-800">{{ $produto->categoria->nome }}</span></li>
              ...
              <li class="text-gray-400"><span class="text-gray-600">Ultra-soft 100% cotton</span></li> --}}
                        ...
                        <div class="mt-10">
                            ...
                            <div class="mt-4 space-y-6">
                                <p class="text-sm text-indigo-600">{{ $produto->user->first_name }}</p>
                            </div>
                        </div>
                    </div>
                </div>
