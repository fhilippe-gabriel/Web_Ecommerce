            ...
            <div class=" mx-auto max-w-7xl px-6 lg:px-8">
                            ...
                            @foreach ($itens as $item)
                                <div class="">
                                    <a href="#" class="">
                                        ...
                                        <h3 class="mt-4 text-sm text-gray-700">{{ $item->name }}
                                    ...
                                    {{-- Remover do carrinho --}}
                                    <form id="remove-item-{{ $item->id }}" action="{{ route('site.removecarrinho') }}"
                                    ...
                                    <div class="mt-2 flex items-center gap-2">
                                        ...
                                        <button type="submit" form="remove-item-{{ $item->id }}"
                ...
                <div class="border-t border-gray-200 px-4 py-6 sm:px-6">
                    <div class="flex justify-between text-base font-medium text-gray-900">
                        <p>Subtotal</p>
                        <p class="subtotal-amount">${{ number_format(\Cart::getTotal(), 2, '.', ',') }}</p>
                    </div>
                    <div class="mt-6">
                        <a href="#"
                    ...
                    <div class="mt-6 flex justify-center text-center text-sm text-gray-500">
                        <p>
                            ...
                            <a href="{{ route('site.index') }}" type="button" command="close" commandfor="drawer"
