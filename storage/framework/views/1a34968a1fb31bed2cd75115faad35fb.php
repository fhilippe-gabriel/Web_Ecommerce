            ...
            <div class="space-y-12">
                        ...
                        <div class="col-span-full">
                            ...
                            <div
                                ...
                                <div class="text-center">
                                    <svg viewBox="0 0 24 24" fill="currentColor" data-slot="imagem" aria-hidden="true"
                                    ...
                                    <div class="mt-4 flex text-sm/6 text-gray-600">
                                        <label for="imagem"
                                            ...
                                            <input id="imagem" type="file" name="imagem" class="sr-only" />
                                        </label>
                ...
                <div class="border-b border-gray-900/10 pb-12">
                    ...
                    <div class="sm:col-span-3">
                        <label for="id_categorias" class="block text-sm/6 font-medium text-gray-900">Categoria</label>
